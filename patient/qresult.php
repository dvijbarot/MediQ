...
?>
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)"><?php echo $selecttype." Patients"; ?></p>
                    </td>
                        ...
                        <tbody style="padding:20px">
                            ...
                            <?php
                                ...
                                //echo $sqlmain;
                                    ...
                                    $total = 0;
                                    $questionnaire = mysqli_query($database,"SELECT * from questionnaire where pid='$userid'");
