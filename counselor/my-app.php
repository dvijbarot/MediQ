    ...
    <div class="container">
            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-schedule menu-active menu-icon-schedule-active">
                        <a href="schedule.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">My Appointment</p></div></a>
                    </td>
                </tr>
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    <td width="13%" >
                    <a href="my-app.php" ><button  class="login-btn btn-primary-soft btn btn-icon-back"  style="padding-top:11px;padding-bottom:11px;margin-left:20px;width:125px"><font class="tn-in-text">Back</font></button></a>
                    </td>
                    <td>
                    ...
                    <td width="15%">
                        ...
                        $list110 = $database->query("select  * from  counschedule;");
                ...
                <tr>
                    <td colspan="4" >
                        ...
                        <a href="?action=add-session-c&id=none&error=0" class="non-style-link"><button  class="login-btn btn-primary btn button-icon"  style="margin-left:25px;background-image: url('../img/icons/add.svg');">Create Appointment</font></button>
                        </a>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="4" style="padding-top:0px;width: 100%;" >
                        ...
                        <td width="30%">
                        <select name="cid" id="" class="box filter-container-items" style="width:90% ;height: 37px;margin: 0;" >
                            <option value="" disabled selected hidden>Choose Counsellor Name from the list</option><br/>
                                
                            <?php 
                            
                                $list11 = $database->query("select  * from  counselor order by cname asc;");
                ...
                <?php
                    if($_POST){
                        ...
                        if(!empty($_POST["sheduledate"])){
                            ...
                            $sqlpt1=" counschedule.scheduledate='$sheduledate' ";
                        }
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <a class="non-style-link" href="my-app.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Show all Sessions &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
        ...
        if($action=='add-session-c'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <a class="close" href="my-app.php">&times;</a> 
                        <div style="display: flex;justify-content: center;">
                        <div class="abc">
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                <form action="add-sess-c.php" method="POST" class="add-new-form">
                            ...
                            <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <label for="cid" class="form-label">Select Counselor: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <select name="cid" id="" class="box" >
                                    <option value="" disabled selected hidden>Choose Counsellor Name from the list</option><br/>';
            ...
            <div id="popup1" class="overlay">
                    ...
                    <br><br>
                        ...
                        <a href="my-app.php" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;OK&nbsp;&nbsp;</font></button></a>
                        <br><br><br><br>
                        </div>
                    </center>
            </div>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <a href="my-app.php" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;No&nbsp;&nbsp;</font></button></a>
            ...
            $sqlmain= "select counschedule.scheduleid,counschedule.title,patient.pname,counselor.cname,counschedule.scheduledate,counschedule.scheduletime,counschedule.pid from counschedule inner join counselor on counschedule.cid=counselor.cid inner join patient on counschedule.pid=patient.pid where  counschedule.scheduleid=$id";
            $result= $database->query($sqlmain);
            $row=$result->fetch_assoc();
            $cname=$row["cname"];
            $pname=$row["pname"];
            ...
            $sqlmain12= "select * from appointment inner join patient on patient.pid=appointment.pid inner join counschedule on counschedule.scheduleid=appointment.counscheduleid where counschedule.scheduleid=$id;";
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="Email" class="form-label">Counselor of this session: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
